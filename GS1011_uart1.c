...
extern u8 GS1011_Xmit_Char;
extern int GS1011_Xmit_Char_Count;
extern char * GS1011_Xmit_Pointer;

extern char GS1011_Rcvr_Char;
extern int GS1011_Rvcr_Count;
extern int GS1011_Rcvr_Pointer;
...
void GS1011_Received_Data_Handler(void){
 ...
 GS1011_Rvcr_Count++;
 GS1011_Rcvr_Pointer = Add_Char_to_Buffer(&GS1011_Receiver_Buffer, GS1011_Rcvr_Pointer, GS1011_Rcvr_Char);
  ...
  *****************************************************************************/
void Start_GS1011_Send(void){
  if (GS1011_Xmit_Char_Count){
  GS1011_Xmit_Char = *GS1011_Xmit_Pointer;
  GS1011_Xmit_Pointer++;
  GS1011_Xmit_Char_Count--;
  UART1->DR = GS1011_Xmit_Char;
  UART1->CR2 |= (uint8_t)UART1_CR2_TEN | UART1_CR2_TIEN;
  UART1->CR1 |= 0x0040;
  }
  else
   UART1->CR2 &= ((uint8_t)UART1_CR2_TEN ^0xff); 
...
void Sending_GS1011_Data_Handler(void){
  if (GS1011_Xmit_Char_Count != 0){
      ...
      GS1011_Xmit_Pointer++;
      GS1011_Xmit_Char_Count--;}
  else UART1->CR2 &= (uint8_t)~(UART1_CR2_TEN);     
}
