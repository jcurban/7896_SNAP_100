 ...
 */
...
#ifndef _DLIB_SUPPORT_FOR_STM8ABI
  #ifdef __EDG_IA64_ABI
    #define _DLIB_SUPPORT_FOR_STM8ABI 1
  #else
    #define _DLIB_SUPPORT_FOR_STM8ABI 0
  #endif
#endif

#if _DLIB_SUPPORT_FOR_STM8ABI == 1 
   ...
   * call.
   */
  #ifndef _DLIB_STM8ABI_DIFUNC_CONTAINS_OFFSETS
    #define _DLIB_STM8ABI_DIFUNC_CONTAINS_OFFSETS 1
  #endif
#endif /* _DLIB_SUPPORT_FOR_STM8ABI == 1  */
 ...
 */
  ...
  #define _DLIB_TIME_USES_64 0
#endif

#if defined(_DLIB_TIME_USES_64) && !defined(_DLIB_TIME_ALLOW_64)
