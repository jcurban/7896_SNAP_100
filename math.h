...
_C_STD_BEGIN
  ...
  #define HUGE_VAL        _CSTD __stm8abi_HUGE_VAL

  #if _DLIB_ADD_C99_SYMBOLS
    #define HUGE_VALF     _CSTD __stm8abi_HUGE_VALF
    #define HUGE_VALL     _CSTD __stm8abi_HUGE_VALL

    #define INFINITY      _CSTD __stm8abi_INFINITY
    #define NAN           _CSTD __stm8abi_NAN
...
_C_LIB_DECL
                /* double declarations */
__ATTRIBUTES double acos(double);
__ATTRIBUTES double asin(double);
__ATTRIBUTES double atan(double);
__ATTRIBUTES double atan2(double, double);
__ATTRIBUTES double ceil(double);
__ATTRIBUTES double exp(double);
__ATTRIBUTES double fabs(double);
__ATTRIBUTES double floor(double);
__ATTRIBUTES double fmod(double, double);
__ATTRIBUTES double frexp(double, int *);
__ATTRIBUTES double ldexp(double, int);
__ATTRIBUTES double modf(double, double *);
__ATTRIBUTES double pow(double, double);
__ATTRIBUTES double sqrt(double);
__ATTRIBUTES double tan(double);
__ATTRIBUTES double tanh(double);

__ATTRIBUTES double cos(double);
__ATTRIBUTES double cosh(double);
__ATTRIBUTES double log(double);
__ATTRIBUTES double log10(double);
__ATTRIBUTES double sin(double);
__ATTRIBUTES double sinh(double);

#if _DLIB_ADD_C99_SYMBOLS

                /* double declarations */
  __ATTRIBUTES double acosh(double);
  __ATTRIBUTES double asinh(double);
  __ATTRIBUTES double atanh(double);
  __ATTRIBUTES double cbrt(double);
  __ATTRIBUTES double copysign(double, double);
  __ATTRIBUTES double erf(double);
  __ATTRIBUTES double erfc(double);
  __ATTRIBUTES double exp2(double);
  __ATTRIBUTES double expm1(double);
  __ATTRIBUTES double fdim(double, double);
  __ATTRIBUTES double fma(double, double, double);
  __ATTRIBUTES double fmax(double, double);
  __ATTRIBUTES double fmin(double, double);
  __ATTRIBUTES double hypot(double, double);
  __ATTRIBUTES int ilogb(double);
  __ATTRIBUTES double lgamma(double);
  #ifdef _LONGLONG
    #pragma language=save
    #pragma language=extended
    __ATTRIBUTES _Longlong llrint(double);
    __ATTRIBUTES _Longlong llround(double);
    #pragma language=restore
  #endif /* _LONGLONG */
  __ATTRIBUTES double log1p(double);
  __ATTRIBUTES double log2(double);
  __ATTRIBUTES double logb(double);
  __ATTRIBUTES long lrint(double);
  __ATTRIBUTES long lround(double);
  __ATTRIBUTES double nan(const char *);
  __ATTRIBUTES double nearbyint(double);
  __ATTRIBUTES double nextafter(double, double);
  __ATTRIBUTES double nexttoward(double, long double);
  __ATTRIBUTES double remainder(double, double);
  __ATTRIBUTES double remquo(double, double, int *);
  __ATTRIBUTES double rint(double);
  __ATTRIBUTES double round(double);
  __ATTRIBUTES double scalbn(double, int);
  __ATTRIBUTES double scalbln(double, long);
  __ATTRIBUTES double tgamma(double);
  __ATTRIBUTES double trunc(double);

                /* float declarations */
  __ATTRIBUTES float acosf(float);
  __ATTRIBUTES float asinf(float);
  __ATTRIBUTES float atanf(float);
  __ATTRIBUTES float atan2f(float, float);
  __ATTRIBUTES float ceilf(float);
  __ATTRIBUTES float expf(float);
  __ATTRIBUTES float fabsf(float);
  __ATTRIBUTES float floorf(float);
  __ATTRIBUTES float fmodf(float, float);
  __ATTRIBUTES float frexpf(float, int *);
  __ATTRIBUTES float ldexpf(float, int);
  __ATTRIBUTES float modff(float, float *);
  __ATTRIBUTES float powf(float, float);
  __ATTRIBUTES float sqrtf(float);
  __ATTRIBUTES float tanf(float);
  __ATTRIBUTES float tanhf(float);

  __ATTRIBUTES float acoshf(float);
  __ATTRIBUTES float asinhf(float);
  __ATTRIBUTES float atanhf(float);
  __ATTRIBUTES float cbrtf(float);
  __ATTRIBUTES float copysignf(float, float);
  __ATTRIBUTES float erff(float);
  __ATTRIBUTES float erfcf(float);
  __ATTRIBUTES float expm1f(float);
  __ATTRIBUTES float exp2f(float);
  __ATTRIBUTES float fdimf(float, float);
  __ATTRIBUTES float fmaf(float, float, float);
  __ATTRIBUTES float fmaxf(float, float);
  __ATTRIBUTES float fminf(float, float);
  __ATTRIBUTES float hypotf(float, float);
  __ATTRIBUTES int ilogbf(float);
  __ATTRIBUTES float lgammaf(float);
  #ifdef _LONGLONG
    #pragma language=save
    #pragma language=extended
    __ATTRIBUTES _Longlong llrintf(float);
    __ATTRIBUTES _Longlong llroundf(float);
    #pragma language=restore
  #endif /* _LONGLONG */
  __ATTRIBUTES float log1pf(float);
  __ATTRIBUTES float log2f(float);
  __ATTRIBUTES float logbf(float);
  __ATTRIBUTES long lrintf(float);
  __ATTRIBUTES long lroundf(float);
  __ATTRIBUTES float nanf(const char *);
  __ATTRIBUTES float nearbyintf(float);
  __ATTRIBUTES float nextafterf(float, float);
  __ATTRIBUTES float nexttowardf(float, long double);
  __ATTRIBUTES float remainderf(float, float);
  __ATTRIBUTES float remquof(float, float, int *);
  __ATTRIBUTES float rintf(float);
  __ATTRIBUTES float roundf(float);
  __ATTRIBUTES float scalbnf(float, int);
  __ATTRIBUTES float scalblnf(float, long);
  __ATTRIBUTES float tgammaf(float);
  __ATTRIBUTES float truncf(float);

  __ATTRIBUTES float cosf(float);
  __ATTRIBUTES float coshf(float);
  __ATTRIBUTES float logf(float);
  __ATTRIBUTES float log10f(float);
  __ATTRIBUTES float sinf(float);
  __ATTRIBUTES float sinhf(float);

                /* long double declarations */
  __ATTRIBUTES long double acosl(long double);
  __ATTRIBUTES long double asinl(long double);
  __ATTRIBUTES long double atanl(long double);
  __ATTRIBUTES long double atan2l(long double, long double);
  __ATTRIBUTES long double ceill(long double);
  __ATTRIBUTES long double expl(long double);
  __ATTRIBUTES long double fabsl(long double);
  __ATTRIBUTES long double floorl(long double);
  __ATTRIBUTES long double fmodl(long double, long double);
  __ATTRIBUTES long double frexpl(long double, int *);
  __ATTRIBUTES long double ldexpl(long double, int);
  __ATTRIBUTES long double modfl(long double, long double *);
  __ATTRIBUTES long double powl(long double, long double);
  __ATTRIBUTES long double sqrtl(long double);
  __ATTRIBUTES long double tanl(long double);
  __ATTRIBUTES long double tanhl(long double);

  __ATTRIBUTES long double acoshl(long double);
  __ATTRIBUTES long double asinhl(long double);
  __ATTRIBUTES long double atanhl(long double);
  __ATTRIBUTES long double cbrtl(long double);
  __ATTRIBUTES long double copysignl(long double, long double);
  __ATTRIBUTES long double erfl(long double);
  __ATTRIBUTES long double erfcl(long double);
  __ATTRIBUTES long double exp2l(long double);
  __ATTRIBUTES long double expm1l(long double);
  __ATTRIBUTES long double fdiml(long double, long double);
  __ATTRIBUTES long double fmal(long double, long double, long double);
  __ATTRIBUTES long double fmaxl(long double, long double);
  __ATTRIBUTES long double fminl(long double, long double);
  __ATTRIBUTES long double hypotl(long double, long double);
  __ATTRIBUTES int ilogbl(long double);
  __ATTRIBUTES long double lgammal(long double);
  #ifdef _LONGLONG
    #pragma language=save
    #pragma language=extended
    __ATTRIBUTES _Longlong llrintl(long double);
    __ATTRIBUTES _Longlong llroundl(long double);
    #pragma language=restore
  #endif /* _LONGLONG */
  __ATTRIBUTES long double log1pl(long double);
  __ATTRIBUTES long double log2l(long double);
  __ATTRIBUTES long double logbl(long double);
  __ATTRIBUTES long lrintl(long double);
  __ATTRIBUTES long lroundl(long double);
  __ATTRIBUTES long double nanl(const char *);
  __ATTRIBUTES long double nearbyintl(long double);
  __ATTRIBUTES long double nextafterl(long double, long double);
  __ATTRIBUTES long double nexttowardl(long double, long double);
  __ATTRIBUTES long double remainderl(long double, long double);
  __ATTRIBUTES long double remquol(long double, long double, int *);
  __ATTRIBUTES long double rintl(long double);
  __ATTRIBUTES long double roundl(long double);
  __ATTRIBUTES long double scalbnl(long double, int);
  __ATTRIBUTES long double scalblnl(long double, long);
  __ATTRIBUTES long double tgammal(long double);
  __ATTRIBUTES long double truncl(long double);

  __ATTRIBUTES long double cosl(long double);
  __ATTRIBUTES long double coshl(long double);
  __ATTRIBUTES long double logl(long double);
  __ATTRIBUTES long double log10l(long double);
  __ATTRIBUTES long double sinl(long double);
  __ATTRIBUTES long double sinhl(long double);
#endif /* _DLIB_ADD_C99_SYMBOLS */

#ifndef _DLIB_DO_NOT_ADD_ACCURATE_FUNCTIONS
                /* Accurate versions of certain float functions. */
__ATTRIBUTES double __iar_tan_accurate(double);
__ATTRIBUTES double __iar_cos_accurate(double);
__ATTRIBUTES double __iar_sin_accurate(double);
__ATTRIBUTES double __iar_pow_accurate(double, double);

__ATTRIBUTES double __iar_Sin_accurate(double, unsigned int);
__ATTRIBUTES double __iar_Pow_accurate(double, double, short *pex);
#if _DLIB_ADD_C99_SYMBOLS
  __ATTRIBUTES float __iar_tan_accuratef(float);
  __ATTRIBUTES float __iar_cos_accuratef(float);
  __ATTRIBUTES float __iar_sin_accuratef(float);
  __ATTRIBUTES float __iar_pow_accuratef(float, float);

  __ATTRIBUTES float __iar_Sin_accuratef(float, unsigned int);
  __ATTRIBUTES float __iar_Pow_accuratef(float, float, short *pex);

  __ATTRIBUTES long double __iar_tan_accuratel(long double);
  __ATTRIBUTES long double __iar_cos_accuratel(long double);
  __ATTRIBUTES long double __iar_sin_accuratel(long double);
  __ATTRIBUTES long double __iar_pow_accuratel(long double, long double);

  __ATTRIBUTES long double __iar_Sin_accuratel(long double, unsigned int);
  __ATTRIBUTES long double __iar_Pow_accuratel(long double, long double,
                                               short *pex);
#endif /* _DLIB_ADD_C99_SYMBOLS */
#endif /* _DLIB_DO_NOT_ADD_ACCURATE_FUNCTIONS */

_END_C_LIB_DECL

#ifdef __cplusplus
  __ATTRIBUTES double abs(double);
  __ATTRIBUTES double pow(double, int);

  __ATTRIBUTES float abs(float);
  __ATTRIBUTES float acos(float);
  __ATTRIBUTES float asin(float);
  __ATTRIBUTES float atan(float);
  __ATTRIBUTES float atan2(float, float);
  __ATTRIBUTES float ceil(float);
  __ATTRIBUTES float cos(float);
  __ATTRIBUTES float cosh(float);
  __ATTRIBUTES float exp(float);
  __ATTRIBUTES float fabs(float);
  __ATTRIBUTES float floor(float);
  __ATTRIBUTES float fmod(float, float);
  __ATTRIBUTES float frexp(float, int *);
  __ATTRIBUTES float ldexp(float, int);
  __ATTRIBUTES float log(float);
  __ATTRIBUTES float log10(float);
  __ATTRIBUTES float modf(float, float *);
  __ATTRIBUTES float pow(float, float);
  __ATTRIBUTES float pow(float, int);
  __ATTRIBUTES float sin(float);
  __ATTRIBUTES float sinh(float);
  __ATTRIBUTES float sqrt(float);
  __ATTRIBUTES float tan(float);
  __ATTRIBUTES float tanh(float);
  __ATTRIBUTES float acosh(float);
  __ATTRIBUTES float asinh(float);
  __ATTRIBUTES float atanh(float);
  __ATTRIBUTES float cbrt(float);
  __ATTRIBUTES float copysign(float, float);
  __ATTRIBUTES float erf(float);
  __ATTRIBUTES float erfc(float);
  __ATTRIBUTES float exp2(float);
  __ATTRIBUTES float expm1(float);
  __ATTRIBUTES float fdim(float, float);
  __ATTRIBUTES float fma(float, float, float);
  __ATTRIBUTES float fmax(float, float);
  __ATTRIBUTES float fmin(float, float);
  __ATTRIBUTES float hypot(float, float);
  __ATTRIBUTES int ilogb(float);
  __ATTRIBUTES float lgamma(float);

    #ifdef _LONGLONG
      #pragma language=save
      #pragma language=extended
      __ATTRIBUTES _Longlong llrint(float);
      __ATTRIBUTES _Longlong llround(float);
      #pragma language=restore
    #endif /* _LONGLONG */

  __ATTRIBUTES float log1p(float);
  __ATTRIBUTES float log2(float);
  __ATTRIBUTES float logb(float);
  __ATTRIBUTES long lrint(float);
  __ATTRIBUTES long lround(float);
  __ATTRIBUTES float nearbyint(float);
  __ATTRIBUTES float nextafter(float, float);
  __ATTRIBUTES float nexttoward(float, long double);
  __ATTRIBUTES float remainder(float, float);
  __ATTRIBUTES float remquo(float, float, int *);
  __ATTRIBUTES float rint(float);
  __ATTRIBUTES float round(float);
  __ATTRIBUTES float scalbn(float, int);
  __ATTRIBUTES float scalbln(float, long);
  __ATTRIBUTES float tgamma(float);
  __ATTRIBUTES float trunc(float);

  __ATTRIBUTES long double abs(long double);
  __ATTRIBUTES long double acos(long double);
  __ATTRIBUTES long double asin(long double);
  __ATTRIBUTES long double atan(long double);
  __ATTRIBUTES long double atan2(long double, long double);
  __ATTRIBUTES long double ceil(long double);
  __ATTRIBUTES long double cos(long double);
  __ATTRIBUTES long double cosh(long double);
  __ATTRIBUTES long double exp(long double);
  __ATTRIBUTES long double fabs(long double);
  __ATTRIBUTES long double floor(long double);
  __ATTRIBUTES long double fmod(long double, long double);
  __ATTRIBUTES long double frexp(long double, int *);
  __ATTRIBUTES long double ldexp(long double, int);
  __ATTRIBUTES long double log(long double);
  __ATTRIBUTES long double log10(long double);
  __ATTRIBUTES long double modf(long double, long double *);
  __ATTRIBUTES long double pow(long double, long double);
  __ATTRIBUTES long double pow(long double, int);
  __ATTRIBUTES long double sin(long double);
  __ATTRIBUTES long double sinh(long double);
  __ATTRIBUTES long double sqrt(long double);
  __ATTRIBUTES long double tan(long double);
  __ATTRIBUTES long double tanh(long double);
  __ATTRIBUTES long double acosh(long double);
  __ATTRIBUTES long double asinh(long double);
  __ATTRIBUTES long double atanh(long double);
  __ATTRIBUTES long double cbrt(long double);
  __ATTRIBUTES long double copysign(long double, long double);
  __ATTRIBUTES long double erf(long double);
  __ATTRIBUTES long double erfc(long double);
  __ATTRIBUTES long double exp2(long double);
  __ATTRIBUTES long double expm1(long double);
  __ATTRIBUTES long double fdim(long double, long double);
  __ATTRIBUTES long double fma(long double, long double, long double);
  __ATTRIBUTES long double fmax(long double, long double);
  __ATTRIBUTES long double fmin(long double, long double);
  __ATTRIBUTES long double hypot(long double, long double);
  __ATTRIBUTES int ilogb(long double);
  __ATTRIBUTES long double lgamma(long double);

    #ifdef _LONGLONG
      #pragma language=save
      #pragma language=extended
      __ATTRIBUTES _Longlong llrint(long double);
      __ATTRIBUTES _Longlong llround(long double);
      #pragma language=restore
    #endif /* _LONGLONG */

  __ATTRIBUTES long double log1p(long double);
  __ATTRIBUTES long double log2(long double);
  __ATTRIBUTES long double logb(long double);
  __ATTRIBUTES long lrint(long double);
  __ATTRIBUTES long lround(long double);
  __ATTRIBUTES long double nearbyint(long double);
  __ATTRIBUTES long double nextafter(long double, long double);
  __ATTRIBUTES long double nexttoward(long double, long double);
  __ATTRIBUTES long double remainder(long double, long double);
  __ATTRIBUTES long double remquo(long double, long double, int *);
  __ATTRIBUTES long double rint(long double);
  __ATTRIBUTES long double round(long double);
  __ATTRIBUTES long double scalbn(long double, int);
  __ATTRIBUTES long double scalbln(long double, long);
  __ATTRIBUTES long double tgamma(long double);
  __ATTRIBUTES long double trunc(long double);
...
#if !defined(_NO_DEFINITIONS_IN_HEADER_FILES) && !__STM8ABI_PORTABILITY_INTERNAL_LEVEL
...
/* C inline definitions */
...
#endif /* !defined(_NO_DEFINITIONS_IN_HEADER_FILES) && !__STM8ABI_PORTABILITY_INTERNAL_LEVEL */
  ...
  __ATTRIBUTES int _D_FNAME(Dcomp)(double, double);
  #ifndef _FLOAT_IS_DOUBLE
    __ATTRIBUTES int _F_FNAME(Dcomp)(float, float);
  #endif
  #ifndef _LONG_DOUBLE_IS_DOUBLE
    __ATTRIBUTES int _L_FNAME(Dcomp)(long double, long double);
  #endif
...
_C_STD_END
  ...
  #if __STM8ABI_PORTABILITY_INTERNAL_LEVEL
    using _CSTD __stm8abi_HUGE_VAL;
    #if _DLIB_ADD_C99_SYMBOLS
      using _CSTD __stm8abi_HUGE_VALF;
      using _CSTD __stm8abi_HUGE_VALL;
      using _CSTD __stm8abi_INFINITY;
      using _CSTD __stm8abi_NAN;
    #endif /* _DLIB_ADD_C99_SYMBOLS */
  #endif
