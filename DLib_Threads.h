...
#define _DLIB_TLS_QUAL 
  ...
  #define __IAR_DLIB_PERTHREAD_SIZE __segment_size("__DLIB_PERTHREAD")
  #define __IAR_DLIB_PERTHREAD_INIT_SIZE \
                                    __segment_size("__DLIB_PERTHREAD_init")

  #define __IAR_DLIB_PERTHREAD_SYMBOL_OFFSET(symbp) \
    (  (char _DLIB_TLS_MEMORY *) symbp              \
     - (char _DLIB_TLS_MEMORY *) __segment_begin("__DLIB_PERTHREAD"))
  ...
  #define _TLS_DEFINITION(scope, type, name)              \
    ...
    _Pragma("location = \"__DLIB_PERTHREAD\" ")           \
